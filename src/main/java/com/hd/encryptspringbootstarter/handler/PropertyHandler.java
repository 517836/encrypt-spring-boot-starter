...
import com.hd.encryptspringbootstarter.annotation.Badger;
...
//排除含这些名字的类型
     ...
     */
    @SuppressWarnings({"all"})
    private void nestedEncryptHandle(Object process, Field[] declaredFields, List<String> fieldNames, CipherMode cipherMode) throws Throwable {
    ...
    @SuppressWarnings({"all"})
    private void nestedDecryptHandle(Object arg, Field[] declaredFields, List<String> fieldList, CipherMode cipherMode) throws IllegalAccessException, UnsupportedEncodingException {
